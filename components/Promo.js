...
export default function Promo() {
  return (
    <Card className="bg-gradient-to-r from-zinc-800 to-zinc-600 text-white shadow-lg border border-solid dark:border-white">
      <CardHeader className="p-4">
        <CardTitle className="text-white">
          Ship your startup in days,
          <span className="bg-white text-black px-1 ml-1 md:ml-1.5 leading-relaxed sm:whitespace-nowrap">
            not weeks
          </span>
        </CardTitle>
